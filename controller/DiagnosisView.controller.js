    ...
    return BaseController.extend("mymedicalhelpline.controller.DiagnosisView", {
      ...
      onInit: function () {
        ...
        oViewModel = new JSONModel({
          ...
          selectedKey: window.sessionStorage.admin_accessToken
            ? "ADMIN"
            : "DIAGNOSIS",
      ...
      handleRiskAssessment: function (oEvent) {
        ...
        mobile_no = mobile_no
          ? mobile_no
          : parseInt(window.sessionStorage.mobile_no, 10);
        var aContacts = [
          {
            mobile_no: mobile_no,
            contact_id: 1,
          ...
          if (bIsError) {
            ...
            if (aContactList.length) {
              ...
              this.getModel("diagnosisView").setProperty(
                "/showResults",
                !!oUserModel.getProperty("/status_id")
              );
              if (this._oAssessmentDialog) {
                this._oAssessmentDialog.close();
                this._oAssessmentDialog.destroy();
      ...
      handleRiskAssessmentNext: function (oEvent) {
        ...
        switch (this._stepCount) {
          ...
          case 1:
            var oForm = this.getView().byId("addressForm").getContent();
            if (
              !this._onChecks(oForm, oAssessmentModel, true) ||
              oEvent === "PREV"
            ) {
        ...
        if (!bIsError) {
          ...
          oAssessmentModel.setProperty(
            ...
            bIsAddressStep
              ...
              : "Please choose at least one of the below options"
          );
        }
      ...
      _handleFinalStep: function (sStatus) {
        ...
        stepData = {
          ...
          final_msg:
            sStatus !== "LOW"
              ? "Before we show results, we would like you to enter the below information."
              : "Please click 'Show Results' button.",
          status: sStatus,
        };
        oAssessmentModel.setData(stepData);
      },
      ...
      _handleEssentialServices: function (sCity) {
        ...
        $.ajax({
          url:
            "https://covid.icmr.org.in/index.php?option=com_hotspots&view=jsonv4&task=gethotspots&hs-language=en-GB&page=1&per_page=5000&search=" +
            sCity +
            "&cat=&format=raw",
          type: "GET",
      ...
      onCasesStateChange: function (oEvent) {
        ...
        window.sessionStorage.statekey =
          ...
          !!window.sessionStorage.statekey
            ? window.sessionStorage.statekey
            : "KA";
        window.sessionStorage.statekey = sStateKey
          ? sStateKey
          : window.sessionStorage.statekey;
      ...
      handleLocalitySearch: function (oEvent) {
        if (oEvent) {
          ...
          sSearchText =
            ...
            !!window.sessionStorage.contArea
              ? window.sessionStorage.contArea
              : "";
      ...
      redzonesUpdateFinished: function (oEvent) {
        ...
        var iTotalItems = oEvent.getParameter("total"),
          sHeaderText =
            iTotalItems === 0
              ? "0 results"
              : iTotalItems + " Containment zones found";
      ...
      handleTestResultConfirm: function (oEvent) {
        var oObject = oEvent
          ...
          data = {
            ...
            covid_result: oEvent.getParameter("selected")
              ? "POSITIVE"
              : "NEGATIVE",
          };
        this.getModel("adminModel").setProperty(
